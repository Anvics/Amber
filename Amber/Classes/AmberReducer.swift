...
public extension AmberReducer{
    ...
    func reduceInput(action: InputAction, state: State, isCancelled: Bool, performAction: @escaping ActionBlock, performOutputAction: @escaping OutputActionListener) -> State{ return state }
}
